...
//! # use soft_ratatui::{EmbeddedGraphics, SoftBackend};
//! # let backend = SoftBackend::<EmbeddedGraphics>::new(80, 24, mono_8x13_atlas(), None, None);
//!
...
//! # let _ = (rgb_data, rgba_data, transparent_rgba, width, height);
//! # }
//! ```
//!
//! ## Examples
...
#[cfg_attr(docsrs, doc(cfg(feature = "cosmic-text")))]
pub use cosmic_backend::CosmicText;
#[cfg(feature = "unicodefonts")]
#[cfg_attr(docsrs, doc(cfg(feature = "unicodefonts")))]
